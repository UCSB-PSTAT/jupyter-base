                                ...
                                stages{
                                    stage('Deploy latest/version tag') {
                                        ...
                                        steps {
                                            ...
                                            sh 'skopeo copy containers-storage:localhost/$IMAGE_NAME docker://registry.lsit.ucsb.edu/ucsb/${IMAGE_NAME}:latest${IMG_SUFFIX} --dest-username $HARBOR_CREDS_USR --dest-password $HARBOR_CREDS_PSW'
                                            sh 'skopeo copy containers-storage:localhost/$IMAGE_NAME docker://registry.lsit.ucsb.edu/ucsb/${IMAGE_NAME}:v$(date "+%Y%m%d")${IMG_SUFFIX} --dest-username $HARBOR_CREDS_USR --dest-password $HARBOR_CREDS_PSW'
                                        }
                                    }
                                    stage('Deploy weekly tag') {
                                        ...
                                        steps {
                                            ...
                                            sh 'skopeo copy containers-storage:localhost/$IMAGE_NAME docker://registry.lsit.ucsb.edu/ucsb/${IMAGE_NAME}:weekly${IMG_SUFFIX} --dest-username $HARBOR_CREDS_USR --dest-password $HARBOR_CREDS_PSW'
                                        }
                                        post {
                                            always {
